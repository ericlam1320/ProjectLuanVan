...
@section('content')
	...
	<div id="page-wrapper">
			...
			<div class="main-page">
				...
				<div class="row">
						<h3 class="title1">Cập nhật giải đấu :</h3>
						...
						<div class="form-three widget-shadow">
							<form method="POST" class="form-horizontal" action="admin/giai-dau/sua/{{$giaidau->id}}" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group {{ $errors->has('tengiaidau') ? 'has-error' : '' }}">
											...
											<div class="col-md-3">
												<input style="height: 30px" class="form-control1" type="text" name="tengiaidau" value="{{ $giaidau->TenGiaiDau }}">
											</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group {{ $errors->has('nambatdau') ? 'has-error' : '' }}">
											...
											<div class="col-md-3">
												<input type="date" class="form-control date"  name="nambatdau" value="{{$giaidau->NamBatDauMuaGiai}}">
											</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group {{ $errors->has('namketthuc') ? 'has-error' : '' }}">
											...
											<div class="col-md-3">
												<input type="date" class="form-control date"  name="namketthuc" value="{{$giaidau->NamKetThucMuaGiai}}">
											</div>
