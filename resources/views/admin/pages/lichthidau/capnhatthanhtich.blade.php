			...
			<div class="main-page">
				...
				<div class="row">
						...
						<div class="form-three widget-shadow">
							<form method="POST" class="form-horizontal" action="admin/lich-thi-dau/cap-nhat-thanh-tich/{{$trandau[0]->id}}" enctype="multipart/form-data">
									...
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-5">
													<input style="height: 25px" disabled name="tencauthu[]" type="text" value="{{$thanhtich[$i]->HoTen}}">
												</div>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-5">
													<input style="width: 50px; height: 25px" disabled type="text" name="vitri[]" value="{{$thanhtich[$i]->TenViTri}}">
												</div>
											</div>
										</div>
									...
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-5">
													<input style="width: 50px; height: 25px" type="number" min="0" max="300" name="soduongchuyen[]" value="{{$thanhtich[$i]->SoDuongChuyen}}">
												</div>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-5">
													<input style="width: 50px; height: 25px" type="number" min="0" max="300" name="chuyenthanhcong[]" value="{{$thanhtich[$i]->ChuyenThanhCong}}">
												</div>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-5">
													<input style="width: 50px; height: 25px" type="number" min="0" max="90" name="sokientao[]" value="{{$thanhtich[$i]->SoKienTao}}">
												</div>
											</div>
										</div>
									...
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-5">
													<input style="width: 50px; height: 25px" type="number" min="0" max="300" name="solansut[]" value="{{$thanhtich[$i]->SoLanSut}}">
												</div>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-5">
													<input style="width: 50px; height: 25px" type="number" min="0" max="90" name="sobanthang[]" value="{{$thanhtich[$i]->SoBanThang}}">
												</div>
											</div>
										</div>
									...
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-5">
													<input style="width: 50px; height: 25px" type="number" min="0" max="300" name="solancanpha[]" value="{{$thanhtich[$i]->SoLanCanPha}}">
												</div>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-5">
													<input style="width: 50px; height: 25px" type="number" min="0" max="2" name="thevang[]" value="{{$thanhtich[$i]->TheVang}}">
												</div>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-5">
													<input style="width: 50px; height: 25px" type="number" min="0" max="1" name="thedo[]" value="{{$thanhtich[$i]->TheDo}}">
												</div>
											</div>
										</div>
