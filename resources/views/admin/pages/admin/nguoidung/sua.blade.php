			...
			<div class="main-page">
				...
				<div class="widget-shadow" data-example-id="basic-forms"> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" placeholder="Jurgen Kloop" name="hoten">
                    </div>
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" placeholder="jkliverpool@gmail.com" name="email">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="date" class="form-control date" placeholder="ngaysinh"  name="ngaysinh" value="<?= date('Y-m-d') ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" placeholder="Đức" name="quoctich">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" placeholder="Stuttgart" name="noisinh">
                      </div>
                    </div>
