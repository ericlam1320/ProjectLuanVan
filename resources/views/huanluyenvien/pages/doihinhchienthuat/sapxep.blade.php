...
@section ("title")
Liverpool FC - Sắp xếp đội hình chiến thuật
@stop
				...
				<div class="panel-group">
					<div class="panel panel-default">
						<div class="panel-body">
					        ...
					        <form  class="form-horizontal" method="POST" action="huan-luyen-vien/doi-hinh-chien-thuat/sap-xep/{{ $idTranDau }}">
							{{ csrf_field() }}
								...
								<div class="form-group {{ $errors->has('ChienThuat') ? 'has-error' : '' }}">
									<div class="col-sm-12">
										<select name="ChienThuat" class="form-control">
											...
											<option value="{{ old('ChienThuat',$chienthuat->id) }}">
							...
							<div class="form-group"> 
									<div class=" col-sm-12  text-right">
										<button type="submit" class="btn btn-success" style=" margin-top: 25px;">Lưu sắp xếp</button>
									</div>
								</div>
							</form>
