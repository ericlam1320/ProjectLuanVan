					...
					<div class="panel-body">
						<form class="form-horizontal" method="POST" action="huan-luyen-vien/1/chien-thuat/them">
							...
							<div class="form-group {{ $errors->has('TenChienThuat') ? 'has-error' : '' }}">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" placeholder="Nhập tên chiến thuật" name="TenChienThuat" value="{{ old('TenChienThuat') }}">
							...
							<div class="form-group {{ $errors->has('NoiDungChienThuat') ? 'has-error' : '' }}">
								...
								<div class="col-sm-9"> 
									<textarea rows="6" class="form-control" placeholder="Nhập chi tiết chiến thuật" id="NoiDungChienThuat" name="NoiDungChienThuat">{{ old('NoiDungChienThuat') }}</textarea>
							...
							<div class="form-group"> 
								<div class=" col-sm-12  text-right">
									<button type="submit" class="btn btn-success">Thêm chiến thuật</button>
								</div>
							</div>
						</form>
					</div>
