...
@section ("title")
Liverpool FC - Cập nhật giáo trình tập
@stop
	...
	<div class="kode_benner1_cols">
		<div class="container kf_container">
			<ul class="breadcrumb">
				...
				<li class="active">Cập nhật giáo trình tập</li>
			</ul>
		</div>
	</div>
</div>
			...
			<div class="panel-group">
				<div class="panel panel-default">
					<div class="panel-body">
						<form class="form-horizontal" method="POST" action="huan-luyen-vien/1/giao-trinh-tap/sua/{{ $GiaoTrinh->id }}">
							{{ csrf_field() }}
							<div class="form-group {{ $errors->has('TenBaiTap') ? 'has-error' : '' }}">
								<label class="control-label col-sm-2" >Tên bài tập:</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="Nhập tên bài tập" name="TenBaiTap" value="{{ old('TenBaiTap', $GiaoTrinh->TenBaiTap) }}">
							...
							<div class="form-group {{ $errors->has('ThoiLuongLuyenTapToiDa') ? 'has-error' : '' }}">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="Nhập thời lượng luyện tập tối đa" name="ThoiLuongLuyenTapToiDa" value="{{ old('ThoiLuongLuyenTapToiDa',  $GiaoTrinh->ThoiLuongTapToiDa) }}">
							...
							<div class="form-group {{ $errors->has('NoiDungBaiTap') ? 'has-error' : '' }}">
								<label class="control-label col-sm-2" >Nội dung bài tập:</label>
								<div class="col-sm-10"> 
									<textarea rows="6" class="form-control" placeholder="Nhập chi tiết nội dung bài tập" id="NoiDungBaiTap" name="NoiDungBaiTap">{{ old('NoiDungBaiTap', $GiaoTrinh->NoiDungBaiTap) }}</textarea>
							...
							<div class="form-group"> 
								<div class="col-sm-offset-2 col-sm-10 text-right">
									<button type="submit" class="btn btn-success">Cập nhật giáo trình tập</button>
								</div>
							</div>
						</form>
					</div>
