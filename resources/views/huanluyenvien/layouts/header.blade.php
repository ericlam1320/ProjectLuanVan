			...
			<ul class="kode_nave">
				...
				<li><a href="#">Quản lý trận đấu</a>
					<ul>
						...
						<li><a href="huan-luyen-vien/1/doi-hinh">Quản lý đội hình</a></li>
						<li><a href="huan-luyen-vien/1/chien-thuat">Quản lý chiến thuật</a></li>
					</ul>	
				</li>
				<li><a href="huan-luyen-vien/1/suc-khoe-cau-thu">Sức khỏe cầu thủ</a></li>
