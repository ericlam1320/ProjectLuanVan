				...
				<div class="nav4">
				  <div class="container">
					<ul class="kode_nave">
						...
						<li><a href="huan-luyen-vien/1/doi-hinh-chien-thuat">Đội hình chiến thuật</a></li>
						<li><a href="huan-luyen-vien/1/suc-khoe">Sức khỏe cầu thủ</a></li>
						<li><a href="#">Danh mục</a>
							<ul>
								<li><a href="huan-luyen-vien/1/thong-tin-ca-nhan">Thông tin cá nhân</a></li>
								<li><a href="huan-luyen-vien/1/yeu-cau">Phản hồi yêu cầu</a></li>
								 <li><a href="huan-luyen-vien/1/thong-bao">Thông báo</a></li>
								 <li><a href="huan-luyen-vien/1/lich-thi-dau">Lịch thi đấu</a></li>
								 <li><a href="huan-luyen-vien/1/ket-qua">Kết quả</a></li>
							</ul>	
						</li>
					</ul>
					...
					<button class="dl-trigger">Open Menu</button>
						<ul class="dl-menu">
							<li class="active"><a class="active" href="huan-luyen-vien/1">Trang Chủ</a></li>
							<li class="menu-item kode-parent-menu"><a href="huan-luyen-vien/1/lich-luyen-tap">Lịch luyện tập</a></li>
							<li class="menu-item kode-parent-menu"><a href="huan-luyen-vien/1/doi-hinh-chien-thuat">Đội hình chiến thuật</a></li>
							<li><a href="huan-luyen-vien/1/suc-khoe">Sức khỏe cầu thủ</a></li>
