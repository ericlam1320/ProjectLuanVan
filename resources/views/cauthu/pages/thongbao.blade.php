				...
				<div class="main-page">
					...
					<div class="inbox-page row">
						...
						<div class="inbox-row widget-shadow">
							<div class="mail"><img src="./Client/images/user.png" alt=""/></div>
							<div class="mail mail-name"><h6> Huấn luyện viên J.Klopp </h6></div>
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse{{ $i+10 }}" aria-expanded="true" aria-controls="collapse{{ $i+10 }}">
								<div class="mail"><p>Mollis nullam quis risus eget urna  ornare</p></div>
							</a>
							<div class="mail-right"><p>31/05/2018</p></div>
							<div class="clearfix"> </div>
							<div id="collapse{{ $i+10 }}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
								<div class="mail-body">
