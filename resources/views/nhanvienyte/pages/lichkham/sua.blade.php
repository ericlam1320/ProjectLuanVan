			...
			<div class="main-page">
				...
				<div class="widget-shadow" data-example-id="basic-forms"> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" placeholder="LK001" name="malichkham" disabled="disabled">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="date" class="form-control date" placeholder="26/05/2018"  name="ngaykham" value="<?= date('Y-m-d') ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" placeholder="180 Cao Lỗ P4 Q8 TpHCM" name="diadiem">
                    </div>
                  </div>
