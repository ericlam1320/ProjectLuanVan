			...
			<div class="main-page">
				...
				<div class="widget-shadow" data-example-id="basic-forms"> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" placeholder="CTXXX" name="machanthuong" disabled="disabled">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" placeholder="Nhập tên chấn thương" name="tenchanthuong">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" placeholder="Nhập thời gian hồi phục" name="thoigianhoiphuc">
                      </div>
                    </div>
