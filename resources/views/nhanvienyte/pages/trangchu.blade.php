			...
			<div class="main-page">
				...
				<div class="row">
					<div class="col-md-8 map widget-shadow">
						...
						<!--map js-->
						<link href="AdminAssets/css/jqvmap.css" rel='stylesheet' type='text/css' />
						<script src="AdminAssets/js/jquery.vmap.js"></script>
						<script src="AdminAssets/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
						<script src="AdminAssets/js/jquery.vmap.world.js" type="text/javascript"></script>
